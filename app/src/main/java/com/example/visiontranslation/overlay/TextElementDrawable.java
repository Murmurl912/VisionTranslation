...
public class TextElementDrawable extends Drawable {
    ...
    public TextElementDrawable(@NonNull Element element, PointF ratio) {
    ...
    private void initialize() {
        ...
        float a = pointFS[2].x - pointFS[3].x;
        float b = pointFS[2].y - pointFS[3].y;
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.rotate(angle);
        canvas.drawText(element.getValue(), pointFS[3].x, pointFS[3].y, paint);
        canvas.rotate(-angle);
