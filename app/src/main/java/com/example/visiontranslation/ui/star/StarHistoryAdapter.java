...
import com.example.visiontranslation.ui.text.TextTranslationHistoryAdapter;
...
public class StarHistoryAdapter extends RecyclerView.Adapter<StarHistoryAdapter.ViewHolder>{
    ...
    public StarHistoryAdapter(Context context, Activity activity) {
